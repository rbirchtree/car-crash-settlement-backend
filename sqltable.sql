...
timeWithAtty, timeAtAccident, timeRentingACar, timeDoingRehabPerADay, dateRehabIsFinished, hourlyWageForOccupation ,occupation,
zipCodeOfAccident, insurance, age, settlementAmt,notes)
VALUES ('4/21/2019', 32, 2,1,1,1,1,1,'07/01/18',24,'construction',78753, 'ACME', 21, 9700,'He was hit by a truck while driving'); 
...
timeWithAtty, timeAtAccident, timeRentingACar, timeDoingRehabPerADay, dateRehabIsFinished, hourlyWageForOccupation ,occupation,
zipCodeOfAccident, insurance, age, settlementAmt,notes)
VALUES ('5/14/17', 5, 8,1,1,1,1,1,'6/1/17',70,'Mechanical Engineer',9000, 'ACME', 33, 9000,'He was a driving a Prius and the driver ran away'); 